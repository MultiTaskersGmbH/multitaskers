    ...
    <>
      <section>
        ...
        <p>
          ...
          U.S.-based parent company Meta. Further details on data processing can
          be found in the WhatsApp privacy policy at:{" "}
          <a
        ...
        <p>
          ...
          &ldquo;context information&rdquo; related to the communication process
          (metadata).
        </p>
        <p>
        ...
        <p>
          ...
          For details on data processing, please refer to Zoom&rsquo;s privacy
          policy:{" "}
          <a
        ...
        <p>
          ...
          &sect; 26 BDSG according to German Law (Negotiation of an Employment
          Relationship), Art. 6(1)(b) GDPR (General Contract Negotiations) and
          &ndash; provided you have given us your consent &ndash; Art. 6(1)(a)
