  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
      <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
        <h1 className="mb-6 text-5xl lg:text-6xl">Privacy Policy</h1>
        <div>
          <div className="mb-12">
            <h2 className="mb-6">1. An overview of data protection</h2>
          ...
          <div className="mb-12">
            <h2 className="mb-6">2. Hosting</h2>
            <p>
          ...
          <h2 className="mb-6">4. Recording of data on this website</h2>
          <h3>Contact form</h3>
          <p>
          ...
          <p>
            ...
            is being archived no longer exists (e.g., after we have concluded
            our response to your inquiry). This shall be without prejudice to
          ...
          <p>
            ...
            communication content. However, WhatsApp does gain access to
            metadata created during the communication process (for example,
            sender, recipient, and time). We would also like to point out that
            WhatsApp has stated that it shares personal data of its users with
            its U.S.-based parent company Meta. Further details on data
            processing can be found in the WhatsApp privacy policy at:{" "}
            <a
          ...
          <p>We use WhatsApp in the &ldquo;WhatsApp Business&rdquo; variant.</p>
          <p>
          ...
          <h2 className="mb-6">5. eCommerce and payment service providers</h2>
          ...
          <p>
            ...
            required for billing purposes. The legal basis for these processes
            is Art. 6(1)(b) GDPR.
          </p>
          <p>
            The collected customer data shall be deleted upon completion of the
            order or termination of the business relationship and upon
            expiration of any existing statutory archiving periods. This shall
            be without prejudice to any statutory archiving periods.
          </p>
          <h3>
          ...
          <p>
            ...
            in conjunction with the handling of the contract; for instance, with
          ...
          <p>
            ...
            you have expressly consented to the transfer. Any sharing of your
          ...
          <p>
            ...
            permits the processing of data for the fulfilment of a contract or
          ...
          <h4>Apple Pay</h4>
          <p>
            The payment service provider is Apple Inc, Infinite Loop, Cupertino,
            CA 95014, USA. The Apple privacy policy can be found at:{" "}
            <a
          ...
          <p>
            ...
            Dublin 4, Ireland. You can find Google&rsquo;s privacy policy here:{" "}
            <a
          ...
          <p>
            ...
            (hereinafter &ldquo;Stripe&rdquo;).
          </p>
          <p>
            Data transmission to the US is based on the Standard Contractual
            Clauses (SCC) of the European Commission. Details can be found here:{" "}
          ...
          <p>
            ...
            conference, number of participants and other &ldquo;context
            information&rdquo; related to the communication process (metadata).
          </p>
          <p>
          ...
          <p>
            ...
            our company (legitimate interest in the meaning of Art. 6(1)(f)
            GDPR). Insofar as consent has been requested, the tools in question
            will be used on the basis of this consent; the consent may be
          ...
          <p>
            ...
            USA. For details on data processing, please refer to Zoom&rsquo;s
            privacy policy:{" "}
            <a
          ...
          <h2 className="mb-6">7. Custom Services</h2>
          ...
          <p>
            ...
            collection, processing, and use of your data will occur in
          ...
          <p>
            ...
            are &sect; 26 BDSG according to German Law (Negotiation of an
            Employment Relationship), Art. 6(1)(b) GDPR (General Contract
            Negotiations) and &ndash; provided you have given us your consent
            &ndash; Art. 6(1)(a) GDPR. You may revoke any consent given at any
            time. Within our company, your personal data will only be shared
          ...
          <p>
            ...
            you have submitted will be archived on the grounds of &sect; 26 BDSG
            and Art. 6(1)(b) GDPR for the purpose of implementing the employment
          ...
          <p>
            ...
            (Art. 6(1)(f) GDPR) for up to 6 months from the end of the
