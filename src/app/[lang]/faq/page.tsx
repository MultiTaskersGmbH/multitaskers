    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="md:grid md:grid-cols-2 md:gap-12">
          <h2 className="mb-6 text-xl md:sticky md:top-4 md:mb-0 md:self-start">
      ...
      {/* FAQ Topic 2 */}
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <h2 className="mb-6 text-xl md:max-w-lg lg:max-w-xl">
      ...
      {/* FAQ Topic 5 */}
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mb-4 md:max-w-lg lg:max-w-xl">
